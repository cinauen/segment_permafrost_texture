...
# run script with
# nohup bash ./example/run_CNN_fine_tune.sh &>./example/CNN_fine_tune_test_onl_t16v079.log &
...
PARAM_PREP_ID="v079"  # "v079,v158"  # feature prep ID
INPUT_PARAM_FILE_TRAIN=PARAM06_train_BLyaE_v1_HEX1979_A02_set01a_v079t16_fine_tune_on_FadN
INPUT_PARAM_FILE_TEST=PARAM06_test_model_BLyaE_v1_HEX1979_A02_v079t16_fine_tuned_on_FadN
# CV_NUM=0
...
# separate the ID_FEATUREPEP input into an array
...
for id_f in "${ID_FEATURE_PREP_ARRAY[@]}"; do
	...
	#python ./src/cnn_workflow/MAIN_train_incl_aug.py --GPU_LST_STR $GPU_NUM --GPU_num_GLCM $GPU_NUM --CV_NUM $CV_NUM ${BASE_PATH}/2_segment $TEMP_PATH $id_f $PARAM_TRAIN_ID $INPUT_PARAM_FILE_TRAIN
	python ./src/cnn_workflow/MAIN_train_incl_aug_CV.py --GPU_LST_STR $GPU_NUM --GPU_num_GLCM $GPU_NUM ${BASE_PATH}/2_segment $TEMP_PATH $id_f $PARAM_TRAIN_ID $INPUT_PARAM_FILE_TRAIN
